...
## Concorrentes Diretos — Software de Gestão

### 1. Revenda Mais
**URL:** https://revendamais.com.br  

**Posicionamento:** "Sistema de gestão completa para lojas de veículos — 100% online"  
**Proposta de valor:** Simplicidade + integração com 20+ portais + NF-e sem certificado digital amarrado.  
**Base instalada:** +5.000 revendas no Brasil. No mercado desde 2000 (26 anos).

**Preço:** Não divulgado publicamente. Exige demonstração.  

**Pontos fortes:**
- Maior base instalada conhecida (+5k clientes)
- Marca consolidada há 26 anos
- CRM + NF-e + integrador em uma plataforma
- App mobile para cadastro de veículos com fotos
- Auditoria de atividades por usuário

**Gaps e vulnerabilidades:**
- CRM é reativo — não há agente IA que responde leads automaticamente
- Sem lead scoring por intenção de compra
- Sem inteligência de estoque (não diagnostica por que um carro encalhou)
- Preço opaco força a call de vendas (atrito para PME)
...
### 2. BNDV (Banco Nacional de Veículos)
**URL:** https://bndv.com.br  

**Posicionamento:** "Sistema completo para lojas de veículos com rodada de negócios entre lojistas"  
**Proposta de valor:** Gestão + rede de negociação entre revendas (diferencial: "rodada de negócios" B2B entre lojistas).  

**Preço:** Não divulgado. Desde 2009.

**Pontos fortes:**
- Funcionalidade única: rede de intermediação entre lojistas (compra/venda de estoque entre parceiros)
- DocuSign integrado para contratos com assinatura eletrônica
- Storage ilimitado em nuvem (E-DOC)
- Dashboard de vendas em tempo real

**Gaps e vulnerabilidades:**
- Sem agente IA para atendimento de leads
- Sem lead scoring por intenção de compra
- Sem inteligência de estoque — não diagnostica encalhados
...
### 3. PlataformaWeb
**URL:** https://plataformaweb.com.br  

**Posicionamento:** "Gestão financeira avançada e alta performance para lojas de carros"  
**Proposta de valor:** ERP financeiro robusto + integração de portais + site próprio.

**Preço (divulgado — único no mercado que mostra tabela pública):**
| Plano | Mensal | Veículos | Vendas/mês |
|-------|--------|----------|------------|
| Básico | R$ 249,64 | 10 | 3 |
| Intermediário | R$ 486,64 | 30 | 10 |
| Avançado | R$ 1.979,75 | 150 | 60 |

**Pontos fortes:**
- Transparência de preço (raro no segmento)
- Sem fidelidade (cancelamento sem multa)
- Controle financeiro avançado com cálculo de lucro por veículo
- 7 dias de teste grátis

**Gaps e vulnerabilidades:**
- Produto mais caro do segmento (plano Avançado: R$ 1.979/mês) sem proposta clara de ROI em vendas
- Nenhuma funcionalidade de IA ou automação de atendimento
- Sem lead scoring por intenção de compra
...
### 4. Simples Veículo
**URL:** https://simplesveiculo.com.br  

**Posicionamento:** "Sistema completo para lojas de seminovos — especialista em RENAVE"  
**Proposta de valor:** Especialização em seminovos + integração RENAVE (obrigação legal) + multi-sucursal.

**Preço:**
| Plano | Mensal |
|-------|--------|
| Nota Fiscal | R$ 169,90 |
| Inicial | R$ 399,90 |
| Intermediário | R$ 499,90 |
| Completo | R$ 699,90 |
| Enterprise | R$ 1.497,90 |

**Pontos fortes:**
- Integradora oficial RENAVE (ponto regulatório forte)
- Suporte 24h por telefone
- Simples Aprova: consulta crédito em 12 bancos simultaneamente
- App Android e iOS
- Assinatura eletrônica integrada

**Gaps e vulnerabilidades:**
- Posicionamento de compliance (RENAVE) não resolve o problema de conversão de leads
...
### 5. Auto Adm
**URL:** https://autoadm.com.br  

**Posicionamento:** "Sistema para loja de veículos 100% online — gestão + site + CRM"  
**Proposta de valor:** All-in-one com publicação em 60+ portais, site profissional e CRM inclusos.

**Preço:** Não divulgado. Oferece 14 dias grátis.

**Pontos fortes:**
- Integração com 60+ portais de anúncio (maior do segmento)
- Site profissional com domínio próprio incluído
- CRM para organizar leads e equipe
- Trial de 14 dias

**Gaps e vulnerabilidades:**
- CRM passivo — organiza leads, não os atende automaticamente
- Sem IA de atendimento ou SDR automatizado
- Sem lead scoring por intenção de compra
...
### 6. DealerSites
**URL:** https://dealersites.com.br  

**Posicionamento:** Plataforma de sites e marketing digital para revendas de veículos.  
**Proposta de valor:** Sites profissionais otimizados para conversão + integração com portais + gestão de leads digitais.

**Preço:** Não divulgado publicamente.

**Pontos fortes:**
- Foco em presença digital e geração de leads via site próprio
- Integração com portais automotivos
- Templates especializados para revendas
- Ferramentas de marketing digital integradas

**Gaps e vulnerabilidades:**
- Solução de topo de funil (atrai o lead, não converte)
- Sem agente IA de atendimento — lead chega ao site e espera resposta humana
- Sem lead scoring por intenção de compra
...
### 7. AutoAvaliar
**URL:** https://autoavaliar.com.br  

**Posicionamento:** Plataforma de avaliação e precificação de veículos para revendas.  
**Proposta de valor:** Precificação baseada em mercado + avaliação padronizada de veículos usados + benchmarking regional.

**Preço:** Não divulgado publicamente.

**Pontos fortes:**
- Especialização em precificação e avaliação
- Dados de mercado regional para benchmark
- Reduz o risco de comprar caro ou vender barato demais
- Ferramenta útil para quem compra veículos em leilão ou de particulares

**Gaps e vulnerabilidades:**
- Solução pontual e específica (precificação) — não resolve atendimento, leads ou follow-up
- Sem agente IA de atendimento
- Sem lead scoring por intenção de compra
...
### 8. DealerSpace
**URL:** https://dealerspace.com.br  

**Posicionamento:** Plataforma de gestão completa para revendas de veículos.  
**Proposta de valor:** Gestão operacional integrada — estoque, financeiro, CRM, documentação e equipe em uma plataforma.

**Preço:** Não divulgado publicamente.

**Pontos fortes:**
- Gestão integrada de múltiplas áreas da revenda
- Foco em organização e controle operacional
- CRM básico para gestão de leads
- Gestão de equipe comercial

**Gaps e vulnerabilidades:**
- CRM passivo — registra leads, não atua sobre eles
- Sem agente IA de atendimento automático
- Sem lead scoring por intenção de compra
...
### 9. AutoForce
**URL:** https://autoforce.com  

**Posicionamento:** "Plataforma digital automotiva" — tecnologia para todo o ecossistema automotivo.  
**Proposta de valor:** Presença digital + CRM + marketing digital + integração com portais para revendas e concessionárias.

**Preço:** Não divulgado. Foco em reunião consultiva.

**Pontos fortes:**
- Plataforma robusta com múltiplos módulos (site, CRM, leads, marketing)
- Atende desde revendas independentes até concessionárias
- Integração com portais automotivos
- Ferramentas de marketing digital automotivo

**Gaps e vulnerabilidades:**
- Posicionamento amplo (concessionárias + revendas) — sem especialização no problema do multimarca independente
- Sem agente IA de atendimento automático especializado
- Sem lead scoring por intenção de compra
...
## Concorrentes Indiretos — Portais de Anúncio B2B

### 10. iCarros (B2B Revendas)
**URL:** https://icarros.com.br/portalrevenda  

**Posicionamento:** Portal de classificados com app dedicado para lojistas.  
**Proposta de valor:** Audiência de +10 milhões de compradores potenciais.  
...
**Posicionamento:** Maior portal de veículos do Brasil (Santander).  
**Proposta de valor:** Volume + credibilidade de marca + alcance nacional.  
...
## Concorrentes Adjacentes — CRM / Atendimento

### 12. Kommo CRM
**URL:** https://kommo.com  

**Posicionamento:** "CRM para WhatsApp e todos os canais de comunicação"  
**Proposta de valor:** CRM visual de pipeline com salesbot e automações de WhatsApp.

**Preço (Brasil):**
| Plano | Por usuário/mês (anual) |
|-------|------------------------|
| Básico | R$ 66 |
| Avançado | R$ 110 |
| Pro | R$ 197 |
...
**Pontos fortes:**
- Salesbot (chatbot nativo)
- Integração WhatsApp Business API
- Pipeline visual
- IA Agents (cobrados à parte)

**Gaps e vulnerabilidades:**
- Produto horizontal (não especializado em revenda de veículos)
- Curva de configuração alta para lojista não-técnico
...
### 13. Growth Automotivo
**URL:** https://growthautomotivo.com.br  

**Posicionamento:** "Agente de IA para pré-vendas em revendas automotivas"  
**Proposta de valor:** IA no WhatsApp que qualifica leads e aquece para o vendedor.
...
**Gaps e vulnerabilidades:**
- Posicionamento genérico em "automotivo" (inclui concessionárias, frotas)
- Sem lead scoring por intenção de compra documentado
- Sem inteligência de estoque (diagnóstico de encalhados)
- Sem recomendação de portfólio de compras
- Sem mecanismo proprietário comunicado
...
## Matriz Comparativa (v3.0)

| Concorrente | Gestão Estoque | NF-e/RENAVE | CRM | Agente IA | Atendimento <60s | Lead Scoring | Inteligência de Estoque | Done-for-You | Preço Base |
|-------------|---------------|-------------|-----|-----------|------------------|-------------|------------------------|--------------|------------|
| Revenda Mais | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | Sob consulta |
| BNDV | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | Sob consulta |
| PlataformaWeb | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | R$ 249-1.979 |
| Simples Veículo | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | R$ 169-1.497 |
| Auto Adm | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | Sob consulta |
| DealerSites | ❌ | ❌ | Parcial | ❌ | ❌ | ❌ | ❌ | ❌ | Sob consulta |
| AutoAvaliar | Parcial | ❌ | ❌ | ❌ | ❌ | ❌ | Parcial (preço) | ❌ | Sob consulta |
| DealerSpace | ✅ | Parcial | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ | Sob consulta |
...
3. **Nenhum concorrente tem lead scoring por intenção de compra** — ninguém diz ao vendedor quais 3 leads do dia têm maior probabilidade de fechar. Essa é a maior oportunidade de diferenciação da inteligência comercial.

4. **Nenhum concorrente tem inteligência de estoque** — ninguém diagnostica por que um carro específico está encalhado (preço, canal, demanda, anúncio) nem recomenda o que comprar no próximo lote. R$ 9-12k/mês em custo invisível que o mercado ignora.
...
**Gap #11 — Nenhum player conecta lead a veículo específico do estoque**
